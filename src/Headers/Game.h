...
public:
             ...
             button(sf::Vector2f(100, 50))
    {
        ...
        map.init_main_player(client);
        map.init_walls(2);
        map.init_players(client);
                ...
                if (event.type == sf::Event::KeyPressed)
                {
                    if (event.key.code == sf::Keyboard::Key::Escape)
                    {
                        ...
                        if (fullscreen) {
                            ...
                            window.create(sf::VideoMode(resolution.x, resolution.y), "BLAST", sf::Style::Titlebar | sf::Style::Close);
                            window.setFramerateLimit(60);
                            window.setVerticalSyncEnabled(true);
                            view = sf::View(sf::FloatRect(0, 0, resolution.x / 3, resolution.y / 3));
                        }
...
//                window.setView(view);
//                player.move(worldMousePos);
//                if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
//                    map.init_missile(player);
//                }
//            }


            map.main_player_move(view, window);
